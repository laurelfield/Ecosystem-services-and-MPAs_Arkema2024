...
#read in current version of the data collection sheet from Google Drive. Call this dataframe "data".
data <- read_sheet("link", sheet=3, col_names=TRUE)

#read in the paper inventory sheet from Google Drive. This is metadata for papers included in this analysis. Call this dataframe "inventory"
inventory <- read_sheet("link", sheet=2, col_names=TRUE)
